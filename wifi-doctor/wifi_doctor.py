...
from parser_for_testings import extract_all_data_testing_pcap as extract_testing, no_filter_for_1_2 as no_filter_test, replace_phy_type_5_with_7 as replace
...
def run_analysis(pcap_file, parser_name):
    ...
    if analysis_choice == "1":  # Monitor Mode Analysis
        rssi_history = {}
        last_activity = {}
        rssid_log = []
        rssi_log = []
    ...
    elif analysis_choice == "2":  # Performance Analysis
        ...
        print("[ERROR] Invalid analysis choice.")
